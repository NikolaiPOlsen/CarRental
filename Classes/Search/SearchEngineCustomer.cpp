...
void SearchEngineCustomer::searchCustomerID(SQLite::Database& db, const int car_id) {
    int customer_id;
...
void SearchEngineCustomer::searchCustomerName(SQLite::Database &db, const int car_id) {
    int customer_id;
    std::string start_date, end_date, regnr, GivenName;
